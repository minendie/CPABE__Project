...
if not os.path.isfile(f"/home/attr-auth/user-public-key-{uid}.pem"):
    with open(f"/home/attr-auth/user-public-key-{uid}.pem", "w") as f:
        f.write(certificate + "\n")
    f.close()
'''

'''
pem_issuer_public_key = open(f"/home/attr-auth/user-public-key-{uid}.pem")
